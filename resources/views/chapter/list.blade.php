                ...
                <div
                    ...
                    <div class="w-full min-w-0">
                        <h3
                            ...
                            Бүлгийн жагсаалт <a href="{{ route('chapter-create', $manga_id) }}"
                                ...
                                data-headlessui-state="hover" data-hover=""><span
                                    ...
                                    aria-hidden="true"></span>Бүлэг нэмэх</a>
                        </h3>
                                        ...
                                        @foreach ($chapters as $key => $chapter)
                                            <tr class="">
                                                ...
                                                <td
                                                    ...
                                                    <a
                                                        href="{{ route('image-list', ['manga_id' => $manga_id, 'chapter_id' => $chapter->id]) }}">
                                                        <div class="flex items-center gap-2">
                                                            ...
                                                            <span data-slot="avatar"
                                                                class="relative size-8 inline-grid shrink-0 align-middle [--avatar-radius:40%] [--ring-opacity:40%] *:col-start-1 *:row-start-1 outline outline-1 -outline-offset-1 outline-black/[--ring-opacity] dark:outline-white/[--ring-opacity] rounded-full *:rounded-full"><img
                                                                    ...
                                                                    src="data:image/webp;base64,{{ isset($chapter->image) ? $chapter->image : $chapter->manga->image }}"
                                                                    alt=""></span><span
                                                                class="font-medium">{{ $chapter->title }}</span>
                                                    ...
                                                    <div class="relative inline-block text-left">
                                                        ...
                                                        <div class="absolute right-0 z-10 mt-2 bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none hidden"
                                                            ...
                                                            <div class="py-1" role="none">
                                                                <a href="{{ route('chapter-edit', ['manga_id' => $manga_id, 'id' => $chapter->id]) }}"
                                                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                                                                    role="menuitem">Засах</a>
                                                                <form
                                                                    action="{{ route('chapter-delete', ['manga_id' => $manga_id, 'id' => $chapter->id]) }}"
                                                                    method="POST"
                                                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                                                                    role="menuitem"
